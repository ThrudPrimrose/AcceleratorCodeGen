...
from dace.transformation.auto_tile.explicit_memory_move_thread_local import ExplicitMemoryMoveThreadLocal
import json
import numpy as np
...
graph = {
    glb: { glb: 0, a2: 0, b2: 0, a1 : 1, b1: 1, co2 : finf, co1: 1, vecin: 1, vecout: finf },
    a2: { glb: finf, a2: finf, b2: finf, a1 : finf, b1: finf, co2 : finf, co1: 1, vecin: finf, vecout: finf },
    b2: { glb: finf, a2: finf, b2: finf, a1 : finf, b1: finf, co2 : finf, co1: 1, vecin: finf, vecout: finf },
    a1: { glb: finf, a2: 1, b2: finf, a1 : finf, b1: finf, co2 : finf, co1: finf, vecin: finf, vecout: finf },
    b1: { glb: finf, a2: finf, b2: 1, a1 : finf, b1: finf, co2 : finf, co1: finf, vecin: finf, vecout: finf} ,
    co2: { glb: 1, a2: finf, b2: finf, a1 : finf, b1: finf, co2 : finf, co1: finf, vecin: 1, vecout: finf },
    co1: { glb: finf, a2: finf, b2: finf, a1 : finf, b1: finf, co2 : 1, co1: finf, vecin: finf, vecout: finf },
...
for s in sdfg.states():
    ...
    for n in sdutil.dfs_topological_sort(s, dmap):
        if (
            ...
            print("2", dmap, tmap, n)
            ExplicitMemoryMoveThreadLocal().apply_to(
                sdfg=sdfg,
                verify=False,
                ...
                options={
                    ...
                    "intermediate_memory_location": dace.dtypes.StorageType.Ascend_L1,
